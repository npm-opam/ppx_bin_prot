(* OASIS_START *)
(* DO NOT EDIT (digest: 8b26ee01ff80441be94fab2dfcadc8b0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_bin_prot";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\246D\192\202\\\173=Sy{\240\255\222S\150\251";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
